...
def main():
    ...
    if map_name is None:
        ...
        cur_map = Map(sprite_loader, map_name, save_name, scale)
        ...
        for event in pg.event.get():
            ...
            match event.type:
                ...
                case pg.KEYDOWN:
                    match event.key:
                        case pg.K_ESCAPE:
                            esc_menu(root, sprite_loader, map_name)
...
def esc_menu(root, sprite_loader, map_name):
    ...
    while running:
        ...
        for event in pg.event.get():
            ...
            match event.type:
                case pg.QUIT:
                    cur_map.save_map()
                    inventory.save(filename, player, map_name)
                    running = False
                    exit()
